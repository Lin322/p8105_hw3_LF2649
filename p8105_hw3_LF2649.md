...
```
    ...
    ##    id          date        prcp  snow  snwd  tmax  tmin tmin_c tmax_c prcp_mm
    ##    <chr>       <date>     <dbl> <int> <int> <dbl> <dbl>  <dbl>  <dbl>   <dbl>
    ##  1 US1NYAB0001 2007-11-01    NA    NA    NA    NA    NA     NA     NA      NA
    ##  2 US1NYAB0001 2007-11-02    NA    NA    NA    NA    NA     NA     NA      NA
    ##  3 US1NYAB0001 2007-11-03    NA    NA    NA    NA    NA     NA     NA      NA
    ##  4 US1NYAB0001 2007-11-04    NA    NA    NA    NA    NA     NA     NA      NA
    ##  5 US1NYAB0001 2007-11-05    NA    NA    NA    NA    NA     NA     NA      NA
    ##  6 US1NYAB0001 2007-11-06    NA    NA    NA    NA    NA     NA     NA      NA
    ##  7 US1NYAB0001 2007-11-07    NA    NA    NA    NA    NA     NA     NA      NA
    ##  8 US1NYAB0001 2007-11-08    NA    NA    NA    NA    NA     NA     NA      NA
    ##  9 US1NYAB0001 2007-11-09    NA    NA    NA    NA    NA     NA     NA      NA
    ## 10 US1NYAB0001 2007-11-10    NA    NA    NA    NA    NA     NA     NA      NA
    ## # ... with 2,595,166 more rows

``` r
ny_noaa %>% 
  group_by(snow) %>% 
  summarise(snowfall_mm = n())
```
